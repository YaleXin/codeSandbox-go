                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/vo.QuestionAndAnswer"
                                            }
                                        }
                                    }
                                }
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.DeleteKeyRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "vo.AdminExecutionVO": {
            ...
            "properties": {
                ...
                "userId": {
                    "description": "执行该代码的用户id",
                    "type": "integer"
                },
                "username": {
                    "description": "执行该代码的用户名字",
                    "type": "string"
                }
            }
        },
